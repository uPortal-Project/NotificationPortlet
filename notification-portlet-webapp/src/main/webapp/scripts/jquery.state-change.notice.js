...
var upStateNotice = upStateNotice || {};

if (!upStateNotice.init) {

  upStateNotice.init = true;
  ...
  (function() {
    ...
    upStateNotice.show = function ($, container, options) {
    ...
    upStateNotice.pullFeed = function ($, options, callback) {
        var settings = $.extend({}, defaults, options);
