export default {
  props: {
    id: String,
    invokeActionUrl: String,
    invokeNotificationServiceUrl: String,
  ...
  methods: {
    ...
    submit: function(notificationId, actionId, index) {
      ...
      const formBody = Object.keys(formData)
        ...
        .join("&");
      this.$http
        .post(this.invokeActionUrl, formBody, {
          credentials: "include",
        ...
        .catch(function() {
          ...
          console.error("Problem posting request");
        });
    },
  ...
  mounted: function() {
    this.$nextTick(function() {
      ...
      this.$http.post(this.invokeNotificationServiceUrl);
      this.$http
        .post(this.getNotifications)
